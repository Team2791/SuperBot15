...
/**
	Unashamedly "borrowed" from https://github.com/glnds/LedStrip.
 */
public final class LED {
    ...
    private Port SPIport; //some sort of enum I guess?
    private SPI spi;
    static {
     ...
     */
    public LED(final int numberOfLeds, final float brightness) throws IllegalArgumentException {
    ...
    public void update() {
        ...
        // Update the strand
        spi.write(packet, this.numberOfLeds * 3);

        byte endPacket[] = {(byte) 0x00};

        // Flush the update
        spi.write(endPacket, 1);
    }
